...
export const newReview = (reviewData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`https://ec-server.onrender.com/api/v1/review`, reviewData, {
            headers: {
...
export const getAllReviews = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://ec-server.onrender.com/api/v1/review?id=${id}`);
...
export const getAdminProduct = () => async (dispatch) => {
    try {
        ...
        const token = JSON.parse(localStorage.getItem("auth"));
        const { data } = await axios.get("https://ec-server.onrender.com/api/v1/admin/products", {
            headers: {
                'token': token?.accessToken
            }
        });
...
export const deleteProduct = (id) => async (dispatch) => {
    try {
        ...
        const token = JSON.parse(localStorage.getItem("auth"));
        const { data } = await axios.delete(`https://ec-server.onrender.com/api/v1/admin/product/${id}`, {
            headers: {
                'token': token?.accessToken
            }
        });
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const token = JSON.parse(localStorage.getItem("auth"));
        const { data } = await axios.put(`https://ec-server.onrender.com/api/v1/admin/product/${id}`, productData, {
            headers: {
                'token': token?.accessToken
            }
        });
